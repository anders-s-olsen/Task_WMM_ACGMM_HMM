        ...
        for r in range(num_repsouter):
            ...
            for r2 in range(num_repsinner):
                if m==0:
                    ...
                    test_like = -model0.log_likelihood_mixture(data_test_concat)
                    ...
                    np.savetxt('../data/real_K/K'+str(K)+'ACG_MM_likelihood'+str(r)+'.csv',test_like)
                elif m==1:
                    ...
                    test_like = -model1.forward(data_test)
                    ...
                    np.savetxt('../data/real_K/K'+str(K)+'ACG_HMM_likelihood'+str(r)+'.csv',test_like)
                elif m==2:
                    ...
                    np.savetxt('../data/real_K/K'+str(K)+'Watson_MM_likelihood'+str(r)+'.csv',test_like)
                    ...
                    np.savetxt('../data/real_K/K'+str(K)+'Watson_HMM_likelihood'+str(r)+'.csv',test_like)
